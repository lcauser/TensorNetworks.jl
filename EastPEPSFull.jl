...
psi, energy = fullupdate(psi, gate, 0.01, sh, ops, coeffs; maxdim=1, maxiter=1000, miniter=10)
psi, energy = fullupdate(psi, gate, 0.001, sh, ops, coeffs; maxdim=1, maxiter=1000, miniter=10)
push!(energies, energy)
...
push!(energies, energy)
psi, energy = fullupdate(psi, gate, 0.01, sh, ops, coeffs; maxdim=2, maxiter=1000, miniter=10)
psi, energy = fullupdate(psi, gate, 0.001, sh, ops, coeffs; maxdim=2, maxiter=1000, miniter=10)
push!(energies, energy)
...
push!(energies, energy)
psi, energy = fullupdate(psi, gate, 0.01, sh, ops, coeffs; maxdim=3, maxiter=1000, miniter=10)
psi, energy = fullupdate(psi, gate, 0.001, sh, ops, coeffs; maxdim=3, maxiter=1000, miniter=10)
push!(energies, energy)
...
push!(energies, energy)
psi, energy = fullupdate(psi, gate, 0.01, sh, ops, coeffs; maxdim=4, maxiter=1000, miniter=10)
psi, energy = fullupdate(psi, gate, 0.001, sh, ops, coeffs; maxdim=4, maxiter=1000, miniter=10)
push!(energies, energy)
